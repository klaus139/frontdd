...
import { FormSubmit, RootStore, ICategory } from '../utils/Type'
...
const Category = () => {
  ...
  const handleSubmit = (e: FormSubmit) => {
    ...
    if(edit){
      ...
      dispatch(updateCategory(data, auth.access_token)as unknown as any)
    }else{
  ...
  const handleDelete = (id: string) => {
    ...
    if(window.confirm('Are you sure to delete this category?')){
      dispatch(deleteCategory(id, auth.access_token)as unknown as any)
    }
  }
