    ...
    <div className="payment">
      ...
      <div className="payment__info">
        <div className="payment__card">
          <h2 className="payment__card-title">
            Pay with Card Each download costs{" "}
            <span className="span">₦3000.</span>
          </h2>
          <p className="payment__card-text">
            You can pay via bank transfer or via card upon successful payment
            the pdf document will be sent to your email
          </p>
        ...
        <div className="payment__bank">
          <h2 className="payment__bank-title">
            You can also pay using bank transfer.
          </h2>
          <p className="payment__bank-text">
            Send the receipt of your payment to our email{" "}
            <a href="mailto:oleanproject@gmail.com" className="p-text">
              oleanproject@gmail.com
            </a>{" "}
            or chat us on whatsapp +2348117830247 and we will send the file upon
      ...
      <div>
        ...
        <div className="payment__contact-card">
          <img
            ...
            className="imgg"
          />
          <a href="tel:+2348065252945" className="p-text">
            +2348065252945
          </a>
        </div>
      </div>
